...
async function displayFile() {
  ...
  if (validExtensions.includes(fileType)) {
    ...
    fileReader.onload = async () => {
      ...
      const classPrediction = prediction[maxPredictionIndex].className + ": " + prediction[i].probability.toFixed(2);
      labelContainer.textContent = classPrediction; // Set the entire content
